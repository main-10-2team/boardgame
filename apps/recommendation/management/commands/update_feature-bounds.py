    ...
    def handle(self, *args, **options):
        ...
        try:
            bounds = Game.objects.aggregate(
                ...
                min_players=Min('min_players'), max_players=Max('max_players'),
                min_playtime=Min('playtime_min_minutes'), max_playtime=Max('playtime_max_minutes'),
                min_difficulty=Min('difficulty'), max_difficulty=Max('difficulty'),
            )
