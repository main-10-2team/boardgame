...
class CustomUserAdmin(UserAdmin):  # type: ignore
    ...
    list_display = ("user_id", "email", "nickname", "role", "status", "is_active", "is_staff", "is_superuser")
...
class SocialAccountAdmin(admin.ModelAdmin):  # type: ignore
...
class AccountDeletionReasonAdmin(admin.ModelAdmin):  # type: ignore
