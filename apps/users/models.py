...
class UserPreferencePlaytime(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, null=True) # Allowing null initially based on ERD, but auto_now_add is usually not null
    updated_at = models.DateTimeField(auto_now=True, null=True) # Allowing null initially based on ERD, but auto_now is usually not null
